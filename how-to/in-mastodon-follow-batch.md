...
> [!Warning]
> 存在超时的问题，并且无法得知是哪些账户，虽然我的导入大部分是成功的，但现在一直显示导入中。可能的原因是关注的账户存在「加锁」问题，有些账户并不希望被大量的不认识的人关注，所以需要在主人同意之后才能关注。
...
难点：无法知道这个站点是不是 Mastodon，按钮显示是个问题

...
## Why
## How
  - [x] #gtd/todo  Now the main function is done, which build with [[python]]. Check [Github Gist](https://gist.github.com/bGZo/f3c4876e230308fc3d2b2bc8db9dd55e)  
```shell
    echo %cd%
    # Dropped to shortcut
...
#### Solution
      ...
      - [x] #gtd/todo  `[404: This page could not be found](https://tweetpik.com/api/tweets/id`)  
```python
          import requests
          import re

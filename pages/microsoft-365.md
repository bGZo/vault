...
http://setup.office.com

注意：其中的+3个月，需要您在绑定的过程中开通自动续费才能有（15个月全部到账后可以再关闭自动续费，建议到账后立即关闭自动续费）。每个账户仅限一次（之前通过这种方式加了3个月的不能再加）。
绑定激活：
1.打开Office激活官网：setup.office.com
2.登录您的微软账户，如果没有微软账户，请先使用邮箱创建一个。
3.输入产品密钥，选择国家地区和语言，然后点下一步
4.关闭自动续订后，点确定。（注意要关闭自动续订，要不到期后会自动在你微软账户里面按原价扣钱）
5.获取Office应用，下一步完成。
未安装Office365软件的请继续完成安装步骤。
激活安装如遇到问题可联系客服帮忙解决
赠送的OfficePLUS会员兑换码请联系客服领取
